...
// Generated: 1/26/2012 3:00:04 PM
// Root namespace: Noef.Benchmarks.DataAccess.Noef
// SQL CE support: False
...
namespace Noef.Benchmarks.DataAccess.Noef
{
//
// ColumnMetadata.cs
//
		...
		public static void ApplyValues(object obj, IEnumerable<KeyValuePair<string, object>> values, bool throwOnBadProp = true)
		{
			...
			foreach(KeyValuePair<string, object> pair in values)
			{
				try
				{
					...
					else if (prop.PropertyType.IsInstanceOfType(pair.Value)
						|| (isNullable && prop.PropertyType.GetGenericArguments()[0].IsInstanceOfType(pair.Value)))
					{
...
//
	...
	public class TableMetadata
	{
		...
		/// Constructor.
		/// </summary>
		public TableMetadata(Type type, string tableName, IList<ColumnMetadata> columns, bool useHyperPropertyDescriptor = true)
		{
			if (useHyperPropertyDescriptor)
				HyperTypeDescriptionProvider.Add(type);
			Type = type;
...
namespace Noef.Benchmarks.DataAccess.Noef.Hyper
{
//
