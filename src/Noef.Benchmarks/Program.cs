...
namespace Noef.Benchmarks
{
	...
	{
		public static readonly string connectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=NoefTests;Integrated Security=True";
...
";
		...
		{
			var tester = new PerformanceTests.Tests();
			foreach (var method in typeof (PerformanceTests.Tests).GetMethods(BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly))
			{
